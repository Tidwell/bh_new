...
template.prototype.stage = function() {
  return '<div class="stage"><div class="buttons"><ul class="chars"></ul><ul class="actionbars"></ul></div><canvas width="800" height="500" id="effects"></canvas><canvas width="800" height="500" id="movement-lines"></canvas><a href="#home" class="home button">Home</a></a></div>';      
}
